...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'template_path',
        type=str, help='Path to the HTML template file.')
    parser.add_argument(
        'output_path', type=str, help='Path to the output HTML file.')
    parser.add_argument(
        '--namespace', type=str,
        default='', help='Optional namespace to replace in the template.')
